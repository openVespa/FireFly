...
volatile uint8_t timer1_OVF_RPM_copy;
volatile uint8_t timer1H_copy;
volatile uint8_t timer1L_copy;
volatile uint8_t tcA_high;
volatile uint8_t tcA_low;
volatile uint8_t tcB_high;
volatile uint8_t tcB_low;

volatile uint8_t cht_h;
volatile uint8_t cht_l;
volatile uint8_t egt_h;
volatile uint8_t egt_l;
...
int main(void)
{
	...
	//**********************************************************
	SetupHardware();
	RingBuffer_InitBuffer(&FFtoBT_Buffer, FFtoBT_Buffer_Data, sizeof(FFtoBT_Buffer_Data)); 
